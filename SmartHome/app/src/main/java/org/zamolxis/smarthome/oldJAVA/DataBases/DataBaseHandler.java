package org.zamolxis.smarthome.oldJAVA.DataBases;
...
import com.example.zizzz.controlapp.Device;
...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "room_list.db";
    ...
    public void addRoom(Room room) {
        ...
        //add values
        values.put(COLUMN_ROOM_ID, room.getRoom_id());
        values.put(COLUMN_ROOM_NAME, room.getName());
        values.put(COLUMN_ROOM_IMAGE, room.getRoom_icon());
        values.put(COLUMN_ROOM_ID, room.getRoom_id());
    ...
    public void addDevice(Device device) {
        ...
        //add values
        values.put(COLUMN_DEVICE_ID, device.getDevice_id());
        values.put(COLUMN_DEVICE_ROOM_ID, device.getDevice_id_room());
        values.put(COLUMN_DEVICE_NAME, device.getDevice_name());
        values.put(COLUMN_DEVICE_IMAGE, device.getDevice_icon());
    ...
    public void deleteDevice(Device device) {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("DELETE FROM " + TABLE_DEVICES + " WHERE " + COLUMN_ROOM_NAME + " =\"" + device.getDevice_name() + "\"");
        db.close();
    }
